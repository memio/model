...
cs-fix: ## Fixes CS with Swiss Knife and PHP-CS-Fixer
	@$(SWISS_KNIFE) namespace-to-psr-4 spec/Memio/Model --namespace-root 'spec\\Memio\\Model\\'
	@$(SWISS_KNIFE) namespace-to-psr-4 src/Memio/Model --namespace-root 'Memio\\Model\\'
